...
<head>
<title>MS ACCESS NEWS	 : Latest news of Access</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
	<br>
      <h2>MICROSOFT ACCESS NEWS</h2>
<pre>	
MS ACCESS 2013 is the latest version released in the year 2013,
 the version is 15.0. It is included in OFFICE 2013.
It has the following new features : 
* With Access 2013, you can still create traditional desktop 
databases from scratch. Or, try out a template to create an app, 
a desktop database, or an Access 2010-style web database.
* Table templates
...
MS Access Support Link : <a href="msaccesssupp.jsp">SUPPORT</a>
<br>
MS Access Link : <a href="msaccess.jsp">ACCESS</a>
<br>
