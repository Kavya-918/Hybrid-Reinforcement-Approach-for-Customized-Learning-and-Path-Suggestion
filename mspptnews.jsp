...
<head>
<title>MS POWERPOINT NEWS	: Latest news of Powerpoint</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
	<br>
      <h2>MICROSOFT POWERPOINT NEWS</h2>
<pre>	MS POWERPOINT 2013 is the latest version released in the year 2013,
...
* Shape tools got improvements
* New formatting tools 
* Improved video input and output 
* Expanded Audio playback options
* Work better with your team, using Comments task pane
